...
local function codeGenerator(register)
  ...
  return {
    ...
    0x75, 0x07, 
    0x90, 0x90, 0x90, 0x90, 0x90, -- reserved space for IMMEDIATE custom protocols callback detour
    0xEB, 0x0A, 
    0x83, registerAssembly, globals.CUSTOM_PROTOCOL_NUMBER2, 
    0x75, 0x05, 
    0x90, 0x90, 0x90, 0x90, 0x90, -- reserved space for LOCKSTEP custom protocols callback detour
    0xC3 
  }
